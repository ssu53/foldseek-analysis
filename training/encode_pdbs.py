...
if __name__ == '__main__':
    ...
    arg.add_argument('--exclude-feat', type=int, help='Do not calculate feature no.',
        default=None)
    arg.add_argument('--encoder_feat_type', type=str, 
        default='foldseek', help='foldseek, esm, or path to custom file')
    ...
    else: # args.encoder_feat_type is a path to pdb_id_encodings
        pdb_id_to_encoding = torch.load(args.encoder_feat_type)
    ...
    for line in sys.stdin:
        ...
        if args.encoder_feat_type == 'foldseek':
            ...
            # feat = feat[:, feature_selector] # ablated
        elif args.encoder_feat_type == 'esm':
